...
public class MainWin implements Initializable {
  ...
  public void showUsluge(ActionEvent actionEvent) {
    FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/FXML/zoneCene.fxml"),
        resources);
  ...
  private void exportCSVtoDatabase(List<File> csvFiles) {
    ...
    for (int i = 0; i < csvDataArrayList.size(); i++) {
      ...
      try {
        ...
        datumZaduzenja = String.valueOf(LocalDate.parse(csvDataSQL.getConnectTime(),
  ...
  public void showZone(ActionEvent actionEvent) {
    FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/FXML/editZone.fxml"),
        resources);
  ...
  public void showPaketi(ActionEvent actionEvent) {
    FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/FXML/editPaketi.fxml"),
        resources);
  ...
  public void showStampa(ActionEvent actionEvent) {
    FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/FXML/stampaRacuna.fxml"),
        resources);
  ...
  public void showMesecniObracune(ActionEvent actionEvent) {
    FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/FXML/mesecniObracuni.fxml"),
        resources);
  ...
  public void showIzvestaje(ActionEvent actionEvent) {
    try {
      FXMLLoader fXMLLoader;
      fXMLLoader = new FXMLLoader(ClassLoader.getSystemResource("FXML/Izvestaji.fxml"));
      Stage stage = new Stage();
      Scene scene = new Scene(fXMLLoader.load());
      IzvestajiController izvestajiController = fXMLLoader.getController();
      IzvestajiController.db = this.db;
      izvestajiController.setData();

      stage.initOwner(bPane.getScene().getWindow());
      stage.initModality(Modality.APPLICATION_MODAL);
      stage.setTitle("Listing poziva");
      stage.setScene(scene);
      stage.showAndWait();
  ...
  public void exportXLSX(ActionEvent actionEvent) {
    FXMLLoader fxmlLoader = new FXMLLoader(ClassLoader.getSystemResource("FXML/ExcelExport.fxml"),
        resources);
    ExcelExportController excelExportController;
    Parent root = null;
    try {
      root = fxmlLoader.load();
      excelExportController = fxmlLoader.getController();
      excelExportController.setDb(this.db);
      Stage stage = new Stage();
      stage.initOwner(bPane.getScene().getWindow());
      stage.initModality(Modality.APPLICATION_MODAL);
