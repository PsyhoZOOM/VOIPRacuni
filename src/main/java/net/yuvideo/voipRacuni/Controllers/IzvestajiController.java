...
public class IzvestajiController implements Initializable {
  ...
  public void initialize(URL url, ResourceBundle rb) {
    ...
    cmbKorisnik.setConverter(new StringConverter<Users>() {
      ...
      public String toString(Users object) {
        ...
        if (object != null) {
          this.user = object;
          cmbString = String.format("%s, %s, %s", object.getPozivNaBroj(), object.getBrojTelefona(),
              object.getIme());
        }
        return cmbString;
      }
    ...
    try {
      ...
      if (rs.isBeforeFirst()) {
        ...
        while (rs.next()) {
          ...
          LocalDateTime st = LocalDateTime.parse(rs.getString("connectTime"),
        ...
        lblPozivaniMin.setText(LocalTime.MIN.plusSeconds(sekunde_ukupno).toString());
      }
  ...
  private void stampaj(ActionEvent event) {
    ...
    try {
      PdfWriter pdfWriter = PdfWriter.getInstance(printPageListin.getDocument(),
