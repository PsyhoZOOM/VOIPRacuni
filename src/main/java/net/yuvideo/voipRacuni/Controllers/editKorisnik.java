...
public class editKorisnik implements Initializable {
  ...
  private void saveUser() {
    ...
    String query =
        "INSERT INTO korisnici (imePrezime, adresa, mesto, postbr, brUgovora, customerID, pozivNaBroj, "
            +
  ...
  private void updateUser() {
    ...
    PreparedStatement ps;
    String query =
        "UPDATE korisnici SET imePrezime=?, adresa=?, mesto=?, postbr=?, brUgovora=?, customerID=?, "
            +
  ...
  public void setData() {
    ...
    dtpDatumPrikljucka.setValue(
        LocalDate.parse(user.getDatumPrikljucka(), DateTimeFormatter.ofPattern("yyyy-MM-dd")));
