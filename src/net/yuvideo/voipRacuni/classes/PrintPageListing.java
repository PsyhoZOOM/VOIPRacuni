...
public class PrintPageListing {
	...
	public void createListing(){
		...
		cell = new PdfPCell(new Phrase(String.format("%s - %s - %s", korisnik, user.getBrojTelefona(), this.period), font));
		...
		PdfPCell footer = new PdfPCell(new Phrase(String.format("Ukupno: %s",
				String.valueOf(LocalTime.MIN.plusSeconds(ukupno).toString())
		), fontLargeBold));
		footer.setColspan(5);
