...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
		...
		FXMLLoader fxmlLoader = new FXMLLoader(ClassLoader.getSystemResource("FXML/connectionWIn.fxml"));
		root = fxmlLoader.load();
        primaryStage.setTitle("Izaberite server za konekciju");
        primaryStage.getIcons().add(new Image(ClassLoader.getSystemResourceAsStream("Assets/YuVideoLogo.png")));
